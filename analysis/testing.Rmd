...
* try/except - this will catch and recover from exceptions
* try/finally - the finally block will execute code regardless of whether an exception occurred or not
